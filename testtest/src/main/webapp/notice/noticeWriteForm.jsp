...
<body>
<h2>새소식 게시물 작성</h2>
<form action="../notice/noticeWrite.do" name="noticeWriteForm" method="post">
	<table id="noticeTable">
		<tr>
			<td class="tableLeft">작성자</td>
			<td>
				<input type="text" name="id" value="새소식 담당자" class="tableRight">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" id="input">
				...
				<input type="button" value="목록으로" class="mybutton" onclick="location.href='noticeList.do?pg=1'">
			</td>
		</tr>
	</table>
</form>
