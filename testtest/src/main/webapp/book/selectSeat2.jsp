...
<script type="text/javascript" src="../js/selectSeat2.js"></script>
</head>
<body>
...
<form action="" name="selectSeat2" method="post">
	...
	<input type="hidden" id="seatPrice2" name="seatPrice2">
		
	<div class="tagTop"><span id="tagTop1">구간 2</span></div>
	...
	<div class="footer">
		<table id="tableBottom" class="seatTable1">
			...
			<tr id="result1">
				<td width="27%">총 결제금액</td><td><span id="showSeatPrice2">0</span></td><td align="left" width="27%">KRW</td>
			</tr>
			<tr id="alert1">
				<td><span class="popUp">
