...
#airReservation #payCard table{
	text-align: center;
	font-size: 14px;
	width: 1200px;
}
#airReservation #payCard table td{
	border: 1px solid #ccc;
}
...
<div id="airReservation">
	...
	<h1>항공권 예매</h1>
	<img alt="" src="../img/airReservation.png"><p>자주항공 홈페이지에서는 24시간 언제든지 항공권을 구입하실 수 있습니다.</p>
	<p>바로가기</p>
	<ul id="quick">
	...
	<div id="payCard">
		...
		<table>
			<tr>
				<td><a>신용/체크카드</a></td>
				<td><span>은행에서 발행된 체크카드는 사용이 가능합니다(한국기준)</span> 해외카드 결제의 경우 VISA, MASTER, JCB, AMEX이용이<br>가능합니다.</td>
			</tr>
			<tr>
				<td><a>법인카드</a></td>
				<td>기명식(개인성명 표기) 법인카드 중 <span>비씨, 국민, 외한, 삼성, 하나, 아멕스, 한미카드는 주민등록 인증절차를 거치시고,<br>그 외의 경우에는 사업자 등록 번호로 인증</span> 받으시기 바랍니다.</td>
			</tr>
			<tr>
				<td><a>직불/선불/기프트카드</a></td>
				<td>직불카드는 신용카드 인증이 불가하며, 선불/기프트카드는 부분 환불 불가로 결제가 불가합니다.</td>
			</tr>
		</table>
		<p>홈페이지에서 항공권을 구매하시는 경우 안전한 전자상거래를 위하여 안전결제(JSP), 안심클릭(MPI)을 통한 신용카드 인증서비스를 실시하고 있습니다.</p>
		<p>- 안전결제(ISP) : <span>비씨카드(하나BC포함), KB카드, 우리카드, 저축은행카드</span></p>
		<table>
			<tr>
				<td>카드구분</td>
				<td>카드사</td>
			...
			<tr>
				<td rowspan="2">법인카드 (일반/체크)</td>
				<td rowspan="2">국민, 비씨</td>
				<td>개별</td>
				<td>안전결제</td>
				<td>안전결제 + 공인인증서</td>
			</tr>
		...
		<p>- 안심클릭(MPI) : <span> 비씨카드(하나BC포함), KB카드, 우리카드, 저축은행카드</span></p>
		<table>
			<tr>
				<td>카드구분</td>
				<td>카드사</td>
			...
			<tr>
				<td>개인카드</td>
				<td>삼성, 신한, 현대, 롯데, 외환</td>
				<td></td>
				<td>안전결제</td>
				<td>안전결제 + 공인인증서</td>
			</tr>
			<tr>
				<td rowspan="5">법인카드</td>
				<td>현대</td>
				<td>개별</td>
				<td>안심클릭 또는 공인인증서</td>
				<td>공인인증서 필수</td>
			...
			<tr>
				<td rowspan="2">삼성, 신한, 외환, 롯데</td>
				<td>공용</td>
				<td>안심클릭</td>
				<td>안심클릭 또는 공인인증서필수</td>
			</tr>
			<tr>
				<td>개별</td>
				<td>안심클릭 또는 공인인증서</td>
	...
	<div id="payCash">
		<h3><img alt="" src="../img/title1.jpg">실시간 계좌이체 구매</h3><p>(이용가능시간 : 01:30 ~ 23:30)</p>
		<ul>
			<li>고객님의 은행계좌에서 실시간으로 항공권 구매금액을 이체하는 서비스 입니다.</li>
			<li><span>회원 로그인 후에만 이용 가능합니다.</span></li>
			<li>제주항공의 실시간 계좌이체 서비스는 금융결제원의 Bank Pay 서비스를 이용하고 있으며 기존 은행/증권사 등의 공인인증서를 소지하고 있는 모든 고객 분은 서비스를 이용하실 수 있습니다.</li>
			<li><span>실시간 계좌이체로 구매하신 항공권의 경우 홈페이지에서 예약변경은 불가능하오니,</span> 예약을 변경하고자 하는 경우에는 환불 후 재 구매 하시기 바랍니다.</li>
			...
			<li>실시간 계좌이체의 서비스 이용 가능시간은 각 금융기관의 사정에 따라 다소 변동될 수 있으며, <span>매일 23:30 ~ 익일 01:30 에는 시스템 작업으로 인하여 계좌이체 서비스가 일시적으로 중단됩니다.</span></li>
		</ul>
	</div>
	<div id="easyPay">
				...
				<td>
					<ul>
						...
						<li>항공권 취소시 카드 환불의 경우 카드사의 사정에 따라 7~10일 정도 소요될 수 있습니다.
							※ 결제 문의 : 삼성페이 고객센터 (1588-7456. 평일 9시 ~ 18시 / 토요일 9시 ~ 13시 / 공휴일 휴무)</li>
					</ul>
				</td>
			</tr>
			<tr>
				...
				<td>
					<ul>
						...
						<li>항공권 취소시 카드 환불의 경우 카드사의 사정에 따라 7~10일 정도 소요될 수 있습니다.
							※ 결제 문의 : 페이코 고객센터 (1544-6819. 평일 10시 ~ 19시 / 토, 일요일 및 공휴일은 휴무)</li>
					</ul>
				</td>
			</tr>
			<tr>
				...
				<td>
					<ul>
						...
						<li>IOS의 경우, 30만원 이상 결제 시 카카오페이에서 제공하는 고객 비밀번호 설정 후 결제할 수 있습니다.
							※ 결제 문의 : 카카오페이 고객센터 (1644-7405. 운영시간 : 한국시간 평일 09:00~18:00)</li>
					</ul>
				</td>
			</tr>
			<tr>
				...
				<td>
					<ul>
						...
						<li>항공권 취소시 카드 환불의 경우 카드사의 사정에 따라 7~10일 정도 소요될 수 있습니다.
							※ 결제 문의 : SSG PAY 고객센터 (1644-1133. 운영시간 : 한국시간 평일 09:00~18:00. 공휴일 휴무)</li>
					</ul>
				</td>
			</tr>
			<tr>
				...
				<td>
					<ul>
						...
						<li>항공권 취소시 카드 환불의 경우 카드사의 사정에 따라 7~10일 정도 소요될 수 있습니다.
							※ 결제 문의 : L Pay 고객센터 (1899-6300. 운영시간 : 한국시간 평일 09:00~18:00. 공휴일 휴무)</li>
					</ul>
				</td>
			</tr>
			<tr>
				<td>Molpay 결제 안내<p>(말레이시아/한국발 일 경우)</p></td>
				<td>
					<ul>
						...
						<li>Molpay로 결제하신 항공권의 환불시, 고객이 계좌정보를 입력한 후 15일 이내 환불됩니다.
							※ 결제 문의 : onlinesupport@eximbay.com</li>
					</ul>
				</td>
			</tr>
			<tr>
				<td>Molpay 결제 안내<p>(태국발 일 경우)</td>
				<td>
					<ul>
	...
	<div id="payPost">
		<h3><img alt="" src="../img/title1.jpg">나중에 결제하기</h3><p>(서비스 잠정 중단 : 2017년 6월 1일 ~)</p>
		<ul>
	...
	<div id="eTiket">
		...
		<ul>
			...
			<li>구매하신 e-티켓의 세부정보는 고객님께서 예약 시 입력하신 e-mail 주소로 송부됩니다. (전화로 신청 시 Fax 로 받아보실 수 있습니다.)</li>
			<li>e-mail 이나 Fax 로 받으신 e-티켓 확인증(예약/발권 확인서) 를 인쇄하신 후 공항 탑승수속 카운터에 제시하시면 좌석배정 및 탑승권발급을 받으실 수 있습니다.</li>
	...
	<div id="qnaGuide">
		...
		<table>
			<tr>
				<td>한국<br>(국내선/국제선 동일)</td>
				<td>
					<ul>
						<li>전화 : 제주항공 고객센터 1499-1400 (해외에서 이용 시 : +82-1499-1400)</li>
			...
			<tr>
				...
				<td>
					<ul>
						<li>전화 : 0570-001132, 1599-1500 (일본어)</li>
