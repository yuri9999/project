...
<body>
<h2>이벤트 게시물 수정</h2>
<form action="../event/eventModify.do?seq=${eventDTO.seq }" name="eventWriteForm" enctype="multipart/form-data" method="post">
	<table id="eventTable">
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="subject" class="tableRight" value="${eventDTO.subject }">
			</td>
		</tr>
		<tr>
			<td class="tableLeft">내용</td>
			<td>
				<textarea rows="25" cols="55" name="content" class="tableRight" style="resize: none;">${eventDTO.content }</textarea>
			</td>
		</tr>
		<tr>
